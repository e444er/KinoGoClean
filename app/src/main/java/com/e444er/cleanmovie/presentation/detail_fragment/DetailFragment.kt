...
class DetailFragment : Fragment(R.layout.fragment_detail) {
    ...
    private fun bindAttributes(
        tvDetail: TvDetail? = null, movieDetail: MovieDetail? = null
    ) {
        ...
        movieDetail?.let {
            ...
            movieDetail.runtime?.let { totalMinutes ->
                ...
                binding.txtRuntime.text = requireContext().getString(
                    R.string.runtime, hour.toString(), minutes.toString()
                )
            }
        ...
        binding.apply {
            ...
            txtVoteAverageCount.text = requireContext().getString(
                R.string.voteAverageDetail, voteAverage.toString().subSequence(0, 3), voteCount
            )
